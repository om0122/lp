...
class Pass2
{
    public static void main(String args[])throws Exception
    {
        ...
        FileWriter f1=new FileWriter("output4.txt");
        BufferedWriter  b1=new BufferedWriter(f1);

        FileReader f2=new FileReader("intermediate1.txt");
        BufferedReader b2=new BufferedReader(f2);

        FileReader f3=new FileReader("symbolTab2.txt");
        BufferedReader b3=new BufferedReader(f3);

        FileReader f4=new FileReader("literalTab3.txt");
...
C:\Users\Desktop\pass2>javac Pass2.java
C:\Users\Desktop\pass2>java Pass2
